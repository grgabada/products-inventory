sap.ui.define([
	"sap/ui/test/Opa5",
	"product/inventory/productinventory/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("product.inventory.productinventory.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "product.inventory.productinventory",
					async: true
				},
				hash: oOptions.hash,
