sap.ui.define([
	...
	return Opa5.extend("product.inventory.productinventory.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["product/inventory/productinventory/localService/mockserver"], function (mockserver) {
