						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#productInventory-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"productInventory-display": {
								"semanticObject": "productInventory",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=product.inventory.productinventory",
									"url": sap.ui.require.toUrl("product/inventory/productinventory")
								}
							}
						}
					}
