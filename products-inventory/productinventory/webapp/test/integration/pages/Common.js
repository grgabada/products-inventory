sap.ui.define([
	...
	return Opa5.extend("products.inventory.productinventory.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["products/inventory/productinventory/localService/mockserver"], function (mockserver) {
